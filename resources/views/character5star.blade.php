...
<body>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="character">
                <div class="kotakCharacter rounded" style="height: 1670px;">
                    <div class="konten mt-3 mx-4">
                        <b class="text-white">5 Stars Characters</b>
                        <?php
    ...
    <div class="footer d-flex justify-content-center bg-warning" style="margin-top: 1780px;">
