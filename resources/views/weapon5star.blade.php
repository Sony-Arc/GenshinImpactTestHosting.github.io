...
<body>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="weapon">
                <div class="kotakweapon rounded" style="height: 860px;">
                    <div class="konten mt-3 mx-4">
                        <b class="text-white">5 Stars weapons</b>
                        <?php
                        $weap = array_values(array_filter($listWeapons, function($weapon){
                                return $weapon['rarity'] == 5;
                            })
                        );
    ...
    <div class="footer d-flex justify-content-center bg-warning" style="margin-top: 970px;">
