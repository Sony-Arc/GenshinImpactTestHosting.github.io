...
<body>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="weapon">
                <div class="kotakweapon rounded" style="height: 460px;">
                    <div class="konten mt-3 mx-4">
                        <b class="text-white">2 Stars weapons</b>
                        <?php
                        $weap = array_values(array_filter($listWeapons, function($weapon){
                                return $weapon['rarity'] == 2;
                            })
                        );
    ...
    <div class="footer d-flex justify-content-center bg-warning fixed-bottom">
