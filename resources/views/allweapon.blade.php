...
<body>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="weapon">
                <div class="kotakweapon rounded" style="height: 6445px;">
                    <div class="konten mt-3 mx-4">
                        <b class="text-white">All Weapons</b>
                        <?php
                        for ($i=0; $i < count($listWeapons); $i += 2) {
                        ?>
                                    ...
                                    <div class='card-body'>
                                        <div class="row ps-1">
                                            <div class="col-3" style="border: 1px solid black; padding: 0px;">
                                                <img src="<?= $listWeapons[$i]['img_url'] ?>" class='card-img-top'
                                                    height="75">
                                            </div>
                                            <div class="col-9" style="margin: -20px 0px; padding-top: 10px;">
                                                <b class='card-text'
                                                    style='font-size: 14px;'><?= $listWeapons[$i]['name'] ?></b>
                                                <div class="separator my-2"
                                                    style=" border: 1px solid black; width: 185px;">
                                                </div>
                                                <p class='card-text' style="font-size: 10px; margin-bottom: 0px;">
                                                    Weapon type: <?= $listWeapons[$i]['type'] ?></p>
                                                <p class='card-text' style="font-size: 10px; margin-bottom: 0px;">
                                                    Attack: <?= $listWeapons[$i]['atk'] ?></p>
                                                <p class='card-text' style="font-size: 10px; margin-bottom: 0px;">
                                                    Rarity:
                                                    <?php
                                                                for ($j = 0; $j < $listWeapons[$i]["rarity"]; $j++) {
                                                                ?>
                            ...
                            <div class="col-6">
                                <div class='card' style='width: 280px; height: 125px; background-color: white;'>
                                    <div class='card-body'>
                                        <div class="row ps-1">
                                            <div class="col-3" style="border: 1px solid black; padding: 0px;">
                                                <img src="<?= $listWeapons[$i + 1]['img_url'] ?>" class='card-img-top'
                                                    height="75">
                                            </div>
                                            <div class="col-9" style="margin: -20px 0px; padding-top: 10px;">
                                                <b class='card-text'
                                                    style='font-size: 14px;'><?= $listWeapons[$i + 1]['name'] ?></b>
                                                <div class="separator my-2"
                                                    style=" border: 1px solid black; width: 185px;">
                                                </div>
                                                <p class='card-text' style="font-size: 10px; margin-bottom: 0px;">
                                                    Weapon type: <?= $listWeapons[$i + 1]['type'] ?></p>
                                                <p class='card-text' style="font-size: 10px; margin-bottom: 0px;">
                                                    Attack: <?= $listWeapons[$i + 1]['atk'] ?></p>
                                                <p class='card-text' style="font-size: 10px; margin-bottom: 0px;">
                                                    Rarity:
                                                    <?php
                            for ($j = 0; $j < $listWeapons[$i+1]["rarity"]; $j++) {
                            ?>
                                                    <svg xmlns="http://www.w3.org/2000/svg" style="color: yellow;"
                                                        width="10" height="10" fill="currentColor"
                                                        class="bi bi-star-fill" viewBox="0 0 16 16">
    ...
    <div class="footer d-flex justify-content-center bg-warning" style="margin-top: 6560px;">
